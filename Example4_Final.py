...
def task_migration_optimized(G, scheduled_tasks, execution_times, T_send, T_cloud, T_receive, T_max=36):
...
def main():
    ...
    print("Results saved to 'Example4_Final' folder")
